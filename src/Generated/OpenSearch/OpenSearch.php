...
class OpenSearch {
  ...
  public function write($output) {
    ...
    if ($this->accessKey !== null) {
      $xfer += $output->writeFieldBegin('accessKey', 11, 1);
      $xfer += $output->writeString($this->accessKey);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->secret !== null) {
      $xfer += $output->writeFieldBegin('secret', 11, 2);
      $xfer += $output->writeString($this->secret);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->host !== null) {
      $xfer += $output->writeFieldBegin('host', 11, 3);
    ...
    if ($this->options !== null) {
      ...
      $xfer += $output->writeFieldBegin('options', 13, 4);
      {
        $output->writeMapBegin(11, 11, count($this->options));
        {
    ...
    if ($this->gzip !== null) {
      $xfer += $output->writeFieldBegin('gzip', 2, 5);
      $xfer += $output->writeBool($this->gzip);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->timeout !== null) {
      $xfer += $output->writeFieldBegin('timeout', 8, 6);
      $xfer += $output->writeI32($this->timeout);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->connectTimeout !== null) {
      $xfer += $output->writeFieldBegin('connectTimeout', 8, 7);
